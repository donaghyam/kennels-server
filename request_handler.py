...
from views import delete_employee, delete_location, delete_animal, delete_customer
from views import update_animal, update_employee, update_customer, update_location
from views import get_customers_by_email, get_animals_by_location, get_employees_by_location
